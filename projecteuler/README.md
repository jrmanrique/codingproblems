...
| 50 | Consecutive prime sum | :small_blue_diamond: [Python](../projecteuler/python/p050.py) [Lua](../projecteuler/lua/p050.lua)
...
| 95 | Amicable chains | :small_blue_diamond: [Lua](../projecteuler/lua/p095.lua)
| 97 | Large non-Mersenne prime | :small_blue_diamond: [Python](../projecteuler/python/p097.py)
| 145 | How many reversible numbers are there below one-billion? | :small_orange_diamond: [Lua](../projecteuler/lua/p145.lua)
